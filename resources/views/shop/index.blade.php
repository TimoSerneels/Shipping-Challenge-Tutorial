    ...
    <form method="get" action="/shop" id="searchForm">
        <div class="row">
            <div class="col-sm-8 mb-2">
                <input type="text" class="form-control" name="artist" id="artist" value="{{ request()->artist }}"
                ...
                <select class="form-control" name="genre_id" id="genre_id">
                    ...
                    @foreach($genres as $genre)
                        <option value="{{ $genre->id }}"
                            {{ (request()->genre_id ==  $genre->id ? 'selected' : '') }}>{{ $genre->name }}
                        </option>
                    @endforeach
                </select>
            </div>
...
{{--            @endforeach--}}
    ...
    <div class="row">
        @foreach($records as $record)
            <div class="col-sm-6 col-md-4 col-lg-3 mb-3 cardflex">
